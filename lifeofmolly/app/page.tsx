...
export default function Home() {
  return (
    <main className="min-h-screen bg-background">
      ...
      <section id="about" className="min-h-screen flex items-center justify-center px-4 py-24 bg-gray-900 text-gray-100 dark:bg-gray-800 dark:text-gray-200">
  <motion.div
    variants={staggerContainer}
    initial="hidden"
    whileInView="show"
  ...
  >
    ...
    <div className="grid gap-8 md:grid-cols-2">
      <motion.div
        ...
        className="rounded-lg border border-gray-700 bg-gray-800 p-6 shadow-lg dark:border-gray-600 dark:bg-gray-900"
      >
        ...
        <div className="space-y-6">
          <div>
            <h4 className="mb-2 text-lg font-semibold text-foreground flex items-center">
              <img
                src="/exclusive-networks-logo.png" // Replace with actual logo URL
                alt="Exclusive Networks Logo"
                className="h-6 w-6 mr-2 object-contain" // Adjust size as needed
              />
              Exclusive Networks
            </h4>
          ...
          <div>
            <h4 className="mb-2 text-lg font-semibold text-foreground flex items-center">
              <img
                src="/reteti-logo.png" // Replace with actual logo URL
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              <a
                href="#"
                className="text-pink-400 hover:underline dark:text-pink-300" // Adjusted link color
              >
                Bragg Live Foods
              </a>{" "}
      ...
      >
        ...
        <div className="space-y-6">
          <div>
            <h4 className="mb-2 text-lg font-semibold text-foreground flex items-center">
              <img
                src="/frisbee-icon.svg" // Replace with actual icon URL or use an appropriate SVG
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              <a
                href="#"
                className="text-purple-400 hover:underline dark:text-purple-300" // Adjusted link color
              >
                here
              </a>
                ...
                <div className="flex flex-1 flex-col p-6">
                  ...
                  <div className="mb-4 flex flex-wrap gap-2">
                    {project.tags.map((tag) => (
                      <Badge key={tag} variant="secondary" className="bg-pink-200 text-gray-800 hover:bg-pink-300 dark:bg-pink-800 dark:hover:bg-pink-700 dark:text-gray-200">
                        {tag}
                      </Badge>
                    ))}
                  </div>
      ...
      <section id="contact" className="min-h-screen flex items-center justify-center px-4 py-24">
        ...
        >
          ...
          >
            ...
            <Button type="submit" className="w-full bg-pink-200 text-gray-800 hover:bg-pink-300 dark:bg-pink-800 dark:hover:bg-pink-700 dark:text-gray-200">
              Send Message
            </Button>
          </motion.form>
